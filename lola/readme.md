...
1. **Fetch**: `git/clone git://shithub.us/aap/lola`
2. **Build**: `cd lola; ed mkfile` (set `OBJ=simple.o`); `mk`
3. **Install**: `cp lola /bin/lola`
4. **Run**: `lola`
5. **Theme**: `mkdir /lib/lola; hget http://aap.papnet.eu/pub/plan9/themes/maya > /lib/lola/maya`; `echo 'settheme /lib/lola/maya' > /mnt/wsys/wctl; echo 'refresh' > /mnt/wsys/wctl`
